...
import { CheckCircle, Shield, Heart, Globe, Users, TrendingUp, ArrowRight, Star, Award, Zap, Sparkles } from "lucide-react";
  ...
  const whyChooseUs = [
    {
      ...
      description: "Track every dollar with real-time updates and detailed impact reports. Know exactly where your donation goes.",
    ...
    },
    {
      ...
      description: "All campaigns are thoroughly vetted and monitored. See real stories and measurable results from your generosity.",
    ...
    },
    {
      ...
      title: "Global Reach",
      description: "Support causes worldwide from your home. Our platform connects you with communities in need across the globe.",
    ...
    },
    {
      ...
      description: "Join thousands of donors making a difference together. Share stories, celebrate impact, and inspire others.",
  ...
  const impactStories = [
    {
      ...
      description: "Your donations built 10 water wells in rural Kenya, providing clean drinking water to over 500 families.",
    ...
    },
    {
      ...
      description: "Supporting 200 children with school supplies, uniforms, and educational materials in underserved communities.",
    ...
    },
    {
      ...
      description: "Mobile medical clinics providing essential healthcare services to 15 remote villages in Nepal.",
        ...
        <div className="container relative z-10">
          ...
          <div className="mx-auto max-w-4xl text-center mb-16 sm:mb-20">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              We believe in making charitable giving simple, secure, and meaningful. Every feature is designed to ensure your generosity creates the biggest possible impact.
            </p>
          </div>
            ...
            {whyChooseUs.map((feature, index) => (
              ...
              >
                ...
                <div className="relative">
                  {/* Icon */}
                  <div className={`mb-4 sm:mb-6 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-primary/20 to-primary/10 border-2 border-primary/30 group-hover:border-primary/50 transition-all duration-500 ${feature.iconColor}`}>
                    {feature.icon}
                  </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-10 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="mx-auto max-w-4xl text-center mb-16 sm:mb-20">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Every donation has a story. Here are just a few examples of how your generosity transforms lives and communities around the world.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="p-4 rounded-xl bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-semibold text-primary">Impact Achieved</span>
                    </div>
          ...
          {/* CTA */}
          <div className="text-center">
            <Button asChild size="lg" className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white px-8 py-6 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Our platform is built with donors in mind, providing powerful tools and features that make charitable giving simple, transparent, and impactful.
              </p>
              
              <div className="grid gap-3 sm:gap-4">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 hover:border-primary/30 transition-all duration-300">
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Your generosity has the power to transform lives, build communities, and create lasting change. Start your journey of impact today.
            </p>
