...
const Hero = ({
  ...
  return (
    <section className="relative overflow-hidden pt-16">
      ...
      <div className="container relative z-10 grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
        {/* Left Content */}
        <div className="mx-auto flex flex-col items-center text-center md:ml-auto lg:max-w-3xl lg:items-start lg:text-left">
          ...
          {/* Main Heading */}
          <h1 className="mb-8 text-pretty text-5xl font-bold leading-tight lg:text-6xl xl:text-7xl bg-gradient-to-r from-foreground via-foreground to-foreground/80 bg-clip-text">
            {heading}
          </h1>

          {/* Description */}
          <p className="mb-12 max-w-2xl text-lg text-muted-foreground lg:text-xl leading-relaxed">
            {description}
          </p>

          {/* Trust Indicators */}
          <div className="mb-12 flex w-fit flex-col items-center gap-6 sm:flex-row">
            {/* Avatar Stack */}
            <div className="flex items-center gap-4">
              <span className="inline-flex items-center -space-x-3">
                {reviews.avatars.map((avatar, index) => (
                  <Avatar key={index} className="size-12 border-2 border-background shadow-lg ring-2 ring-primary/20">
          ...
          {/* Feature Pills */}
          <div className="mb-12 flex flex-wrap items-center gap-3 justify-center lg:justify-start">
            ...
            <div className="flex items-center gap-2 rounded-full bg-blue-50 px-4 py-2 text-sm font-medium text-blue-700 border border-blue-200">
              <Heart className="h-4 w-4" />
              Transparent Impact
            </div>
            <div className="flex items-center gap-2 rounded-full bg-purple-50 px-4 py-2 text-sm font-medium text-purple-700 border border-purple-200">
          ...
          <div className="flex w-full flex-col justify-center gap-4 sm:flex-row lg:justify-start">
            {buttons.primary && (
              <Button 
                asChild 
                size="lg"
                className="w-full sm:w-auto px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary"
              >
        ...
        <div className="relative flex justify-center lg:justify-end">
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-card to-card/80 shadow-2xl">
              ...
              {/* Floating Stats */}
              <div className="absolute top-6 left-6 bg-background/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-border/50">
              ...
              <div className="absolute top-6 right-6 bg-background/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-border/50">
                <div className="text-center">
